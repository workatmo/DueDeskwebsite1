    ...
    return (
        <div className="container pt-44 pb-24 max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-8 text-gray-800 text-lg leading-relaxed text-justify font-medium">
                ...
                <section>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4 underline">What We Stand For</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4 underline">Our Promise</h2>
                    <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 text-center space-y-2">
                        <p className="text-xl font-bold text-primary italic">"No spreadsheets. No payment confusion. No operational chaos."</p>
                ...
                <section className="pt-8 border-t">
                    <p className="text-xl font-bold text-gray-900">One-Line Compliance Summary</p>
